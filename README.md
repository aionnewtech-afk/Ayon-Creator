...
**Sprint 1**, **Missão 2 — "Conheça sua empresa"** (onboarding conversacional), **Missão 3 — Specialist Registry + primeiro Intelligence Hub funcional**, **Missão 4 — "Ensine sua Empresa para a IA"** (Knowledge Base: upload de PDF/DOCX/TXT, nota manual, tags) e **Missão 5 — "O que está em Alta"** (Trend Engine: busca web nativa da Anthropic como Trend Source Provider, sempre atrás do Provider Gateway, candidatos ranqueados pelo Intelligence Hub antes de chegar à tela) implementadas e validadas ponta a ponta (Supabase + Anthropic reais) — ver [CHANGELOG.md](CHANGELOG.md) (`v0.5.0`). **Filosofia de produto consolidada** (Princípio do Consultor Permanente — ver [PRD.md §1.1](PRD.md#11-princípio-do-consultor-permanente-★-novo-revisão-7)). Painel de especialistas + Coordinator AI resolvidos via Specialist Registry — nunca hardcoded — validados quanto a personalidade distinta, divergência real e consolidação ancorada no Brand Brain; Coordinator generalizado na Missão 5 para ser independente do tipo de decisão (formato de saída definido por tarefa, não mais fixo no `system_prompt`). Roadmap confirmado a partir daqui: **Billing**, depois **Asset Engine** e **Learning Engine**, nessa ordem. Documentação de referência para evolução dos especialistas em [docs/prompts/](docs/prompts/).
