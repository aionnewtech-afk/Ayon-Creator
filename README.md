...
**Sprint 1**, **Missão 2 — "Conheça sua empresa"** (onboarding conversacional), **Missão 3 — Specialist Registry + primeiro Intelligence Hub funcional**, **Missão 4 — "Ensine sua Empresa para a IA"** (Knowledge Base), **Missão 5 — "O que está em Alta"** (Trend Engine), **Missão 6 — Billing** (planos Starter/Pro/Business, créditos, Mercado Pago — assinatura recorrente e créditos avulsos, portão de crédito obrigatório antes de qualquer geração) e **Missão 7 — Asset Engine** (geração automática dos 5 formatos textuais do pacote de conteúdo via LLM Provider, upload manual dos 4 formatos visuais, edição/regeneração de peça, montagem automática do pacote final em `.zip`) implementadas e validadas ponta a ponta (Supabase + Anthropic + Mercado Pago reais) — ver [CHANGELOG.md](CHANGELOG.md) (`v0.7.0`). **Filosofia de produto consolidada** (Princípio do Consultor Permanente — ver [PRD.md §1.1](PRD.md#11-princípio-do-consultor-permanente-★-novo-revisão-7)). Painel de especialistas + Coordinator AI resolvidos via Specialist Registry — nunca hardcoded. Roadmap confirmado a partir daqui: **Learning Engine**. Documentação de referência para evolução dos especialistas em [docs/prompts/](docs/prompts/).
