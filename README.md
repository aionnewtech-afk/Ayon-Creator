...
**Sprint 1**, **Missão 2 — "Conheça sua empresa"** (onboarding conversacional), **Missão 3 — Specialist Registry + primeiro Intelligence Hub funcional**, **Missão 4 — "Ensine sua Empresa para a IA"** (Knowledge Base), **Missão 5 — "O que está em Alta"** (Trend Engine) e **Missão 6 — Billing** (planos Starter/Pro/Business, créditos, Mercado Pago — assinatura recorrente e créditos avulsos, portão de crédito obrigatório antes de qualquer geração) implementadas e validadas ponta a ponta (Supabase + Anthropic + Mercado Pago reais) — ver [CHANGELOG.md](CHANGELOG.md) (`v0.6.0`). **Filosofia de produto consolidada** (Princípio do Consultor Permanente — ver [PRD.md §1.1](PRD.md#11-princípio-do-consultor-permanente-★-novo-revisão-7)). Painel de especialistas + Coordinator AI resolvidos via Specialist Registry — nunca hardcoded. Roadmap confirmado a partir daqui: **Asset Engine**, depois **Learning Engine**, nessa ordem. Documentação de referência para evolução dos especialistas em [docs/prompts/](docs/prompts/).
