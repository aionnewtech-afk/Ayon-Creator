...
> **Status do documento:** v1.0 (revisão 27 — Missão 11 aprovada, ressalva de composição resolvida) — dono do produto aprovou com uma ressalva (análise arquitetural obrigatória antes do código para a composição de imagem), resolvida nesta revisão. Decisões residuais não relacionadas à filosofia seguem listadas em §13 e podem ser resolvidas durante o desenvolvimento, conforme necessidade.
